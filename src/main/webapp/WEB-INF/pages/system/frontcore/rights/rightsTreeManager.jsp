...
<table class="table">
	<tr>
		...
		<td  class="va-t">
			<iframe id="contentIframe" name="contentIframe" style="overflow: scroll;" frameborder="0"  width="100%"  height="100%" src="rights/toQuery.htm?fkId=0"></iframe>
		</td>
	</tr>
</table>
...
var setting = {
	async: {
		enable: true,
		url: "<%=basePath%>rights/getRightsNodes.htm",
		autoParam: ["id"]
	},
	view: {
		dblClickExpand: true,
	...
	callback: {
		...
		onClick: function(event, treeId, treeNode) {
			...
			var src = "<%=basePath%>rights/toQuery.htm?fkId="+treeNode.id+"&level="+treeNode.level;
...
function onloadNode(){
	...
	//查询对应的权限集下的权限
	var contentIframe = $("#contentIframe");
	var src = "<%=basePath%>rights/toQuery.htm?fkId="+selectedNode.id+"&level="+selectedNode.level;
	contentIframe.attr("src",src);
}
</script>
</body>
