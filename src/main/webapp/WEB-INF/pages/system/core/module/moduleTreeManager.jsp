...
<table class="table">
	<tr>
		...
		<td  class="va-t">
			<iframe id="contentIframe" name="contentIframe" style="overflow: scroll;" frameborder="0"  width="100%"  height="100%" src="sysModule/toQuery.htm?fkId=0"></iframe>
		</td>
	</tr>
</table>
...
var setting = {
	async: {
		enable: true,
		url: "<%=basePath%>sysModule/getModuleNodes.htm",
		autoParam: ["id"]
	},
	view: {
		dblClickExpand: true,
	...
	callback: {
		...
		onClick: function(event, treeId, treeNode) {
			...
			var src = "<%=basePath%>sysModule/toQuery.htm?fkId="+treeNode.id+"&level="+treeNode.level;
...
function onloadNode(){
	...
	//查询对应的权限集下的权限
	var contentIframe = $("#contentIframe");
	var src = "<%=basePath%>sysModule/toQuery.htm?fkId="+selectedNode.id+"&level="+selectedNode.level;
	contentIframe.attr("src",src);
}
</script>
</body>
