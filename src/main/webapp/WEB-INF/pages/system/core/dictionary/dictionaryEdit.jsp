...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" placeholder="字典名称" id="name" name="name" value="${info.name}"/>
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>字典编码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" placeholder="字典编码" id="code" name="code" value="${info.code}"/>
		</div>
	</div>
	</form>
</article>
	...
	$(function(){
		...
		$("#myForm").validate({
			...
			submitHandler:function(form){
				...
				$.ajax({
					type:"post",
					url:"<%=basePath%>sysDictionary/editSave.htm",
					dataType:"json",
					async:false,
					data:$(form).serialize(),
