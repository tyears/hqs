...
<table class="table">
    <tr>
        ...
        <td  class="va-t">
            <iframe id="contentIframe" name="contentIframe" style="overflow: scroll;" frameborder="0"  width="100%"  height="100%" src="dealer/toQuery.htm?fkId=0"></iframe>
        </td>
    </tr>
</table>
...
<script type="text/javascript">
    ...
    var setting = {
        ...
        callback: {
            ...
            onClick: function(event, treeId, treeNode) {
                ...
                var src = "<%=basePath%>dealer/toQuery.htm?fkId="+treeNode.id+"&level="+treeNode.level;
    ...
    function onloadNode(){
        ...
        //查询对应的权限集下的权限
        var contentIframe = $("#contentIframe");
        var src = "<%=basePath%>dealer/toQuery.htm?fkId="+selectedNode.id+"&level="+selectedNode.level;
        contentIframe.attr("src",src);
    }
</script>
</body>
