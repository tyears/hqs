...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" placeholder="部门名称" id="departName" name="departName" value="${info.departName}"/>
		</div>
	</div>
	</form>
</article>
	...
	$(function(){
		...
		$("#myForm").validate({
			...
			submitHandler:function(form){
				...
				$.ajax({
					type:"post",
					url:"<%=basePath%>depart/editSave.htm",
					dataType:"json",
					async:false,
					data:$(form).serialize(),
