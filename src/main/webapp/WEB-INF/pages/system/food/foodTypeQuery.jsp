...
<div class="page-container">
	<form action="foodType/listPageData.htm" method="post" id="queryForm">
	<div class="text-c">
...
function edit(id){
	...
	var index = layer.open({
		...
		content: "<%=basePath%>foodType/toEdit.htm?id="+id
	});
	//layer.full(index);
}
...
function deleteObjs(id){
	var layerIndex = layer.confirm('确认要删除吗？',{icon:3},function(index){
		$.ajax({
			type:"post",
			url:"<%=basePath%>foodType/deleteData.htm",
			dataType:"json",
			async:false,
			data:{"id":id},
